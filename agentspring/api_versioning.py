...
class VersionManager:
    ...
    def transform_request(
        self, version: str, request_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def transform_response(
        self, version: str, response_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        if version == APIVersion.V1:
            ...
            return {
                ...
                "routing_rules_applied": response_data.get(
...
def versioned_response(version: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return VersionedResponse(
        version=version, timestamp=datetime.now(), data=transformed_data
    ).model_dump()


def versioned_request(
    version: str, request_data: Dict[str, Any]
) -> Dict[str, Any]:
