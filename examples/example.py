...
from agentspring.llm import LLMProvider, get_provider, register_provider
...
async def main():
    ...
    # Register tools
    tool_registry.register("word_count", "Count the number of words in a given text")(word_count)
    tool_registry.register("to_uppercase", "Convert a given text to uppercase")(to_uppercase)
